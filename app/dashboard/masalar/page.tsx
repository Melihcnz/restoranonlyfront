...
export default function Page() {
  ...
  const masalar = [
    { id: 5, numara: 5, durum: "dolu", kapasite: 4, konum: "Salon" },
    { id: 6, numara: 6, durum: "boş", kapasite: 4, konum: "Salon" },
    { id: 7, numara: 7, durum: "boş", kapasite: 4, konum: "Salon" },
    { id: 8, numara: 8, durum: "boş", kapasite: 4, konum: "Salon" },
    { id: 9, numara: 9, durum: "boş", kapasite: 4, konum: "Salon" },
    { id: 10, numara: 10, durum: "boş", kapasite: 4, konum: "Salon" },
    { id: 11, numara: 11, durum: "boş", kapasite: 4, konum: "Salon" },
    { id: 12, numara: 12, durum: "boş", kapasite: 4, konum: "Salon" },
    { id: 13, numara: 13, durum: "boş", kapasite: 4, konum: "Salon" },
    { id: 14, numara: 14, durum: "boş", kapasite: 4, konum: "Salon" },
    { id: 15, numara: 15, durum: "boş", kapasite: 4, konum: "Salon" },
    { id: 16, numara: 16, durum: "boş", kapasite: 4, konum: "Salon" },
    { id: 17, numara: 17, durum: "boş", kapasite: 4, konum: "Salon" },
    { id: 18, numara: 18, durum: "boş", kapasite: 4, konum: "Salon" },
    { id: 19, numara: 19, durum: "boş", kapasite: 4, konum: "Salon" },
  ]
    ...
    >
      ...
      <SidebarInset>
        ...
        <div className="p-4 pt-2">
          ...
          {/* Masa Grid - Kare layout benzeri resime daha yakın */}
            ...
            {masalar.map((masa) => (
              ...
              >
                <div className="flex justify-between items-center p-2 border-b relative overflow-hidden">
                  ...
                  <h2 className="text-xl font-bold relative z-10">Masa {masa.numara}</h2>
                  <div className={`
                ...
                <div className="p-3">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-sm">Durum: {masa.durum}</span>
                  </div>
                </div>
                ...
                {masa.durum === "dolu" && selectedMasa === masa.id && (
                  <div className="p-3 border-t bg-background flex flex-col gap-2">
                    ...
                    <button className="bg-red-500 text-white py-2 rounded-md text-sm 
                      flex items-center justify-center gap-1.5 shadow hover:shadow-md transition-all
